# =============================================================================
# run_wave3_sensitivity.R
#
# Sensitivity analysis for Wave 3 only.
#
# USAGE:
#   1. Run covid19_age_wave3_v2.R and save baseline:
#      saveRDS(prod_chain, "results/baseline_wave3.rds")
#   2. source("run_wave3_sensitivity.R")
# =============================================================================
...
if (!dir.exists("results/wave3"))         dir.create("results/wave3")
...
cat("\n", strrep("=", 70), "\n")
cat("SENSITIVITY ANALYSIS — WAVE 3 ONLY\n")
cat(cfg$label, "\n")
cat(strrep("=", 70), "\n")
...
for (f in f_levels) {
  ...
  if (file.exists(rds_path)) {
    ...
    cat(sprintf("[RUN] f = %.2f\n", f))
    deg_seed <- as.integer(paste0(3, round(f * 100)))
...
saveRDS(summary_df, "results/wave3_summary.rds")
write_csv(summary_df, "results/wave3_summary.csv")
...
saveRDS(metrics_df, "results/wave3_metrics.rds")
write_csv(metrics_df, "results/wave3_metrics.csv")

cat("\n", strrep("=", 70), "\n")
cat("WAVE 3 COMPLETE\n")
cat("Results: results/wave3_summary.rds | results/wave3_metrics.rds\n")
cat("Next: source('sensitivity_plots_wave3.R')\n")
cat(strrep("=", 70), "\n")
